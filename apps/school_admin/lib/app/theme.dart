...
/// The admin app's whole visual language in one place: rounded surfaces,
/// soft borders instead of heavy shadows, generous spacing, and a
/// confident type scale — applied once here so every screen picks it up
/// automatically instead of hand-tuning each widget.
