...
/// `schools/{id}/members/{uid}.displayName` (read by the directory lists) —
/// both self-writes are narrowly scoped in firestore.rules to just that one
/// field, same pattern as every other self-service write in this project.
