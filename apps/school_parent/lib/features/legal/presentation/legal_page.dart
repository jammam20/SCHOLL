...
class LegalPage extends StatelessWidget {
          ...
          InfoNotice(
            ...
            message: const S(
              ...
              'مدرستك هي اللي بتشغّل الخدمة دي وهي مالكة البيانات. أي حاجة '
                  ...
                  'مدرستك.',
              fr:
                  "Votre école gère ce service et possède les données "
                  "qu'il contient. Toute demande de révision, correction "
                  "ou suppression passe par l'administrateur de votre "
                  "école.",
              es:
                  'Su escuela gestiona este servicio y es propietaria de '
                  'los datos que contiene. Cualquier solicitud de '
                  'revisión, corrección o eliminación se tramita a través '
                  'del administrador de su escuela.',
            ).of(context),
          ),
  ...
  // the app does. The French and Spanish bodies are machine translations
  // of the English source, pending native legal review.
  List<Widget> _sections(BuildContext context) => [
    _Section(
      ...
      body: const S(
        ...
        es:
            'Esta aplicación la utiliza una sola escuela para gestionar su '
            ...
            'activo — los introduce el personal de su escuela o usted mismo, y '
            'solo son visibles para el personal aprobado de su propia escuela y '
            ...
            'viaje de un conductor está activo, y únicamente a la escuela de '
            'ese viaje. Los tokens de notificaciones push del dispositivo se '
            ...
            'con el administrador de su escuela — él gestiona su cuenta y puede '
            'atender la solicitud directamente, ya que la escuela (y no esta '
            'aplicación) es la propietaria de esos datos.',
      ).of(context),
    ),
    ...
    _Section(
      ...
      body: const S(
        ...
        es:
            'Las cuentas las aprueba su escuela y pueden ser suspendidas o '
            'eliminadas por la escuela a su discreción. La información de '
            ...
            'escolar y no sustituye a la comunicación directa con la escuela en '
            'caso de emergencia.',
      ).of(context),
    ),
  ];
